...
#summary(rt)
rt$sexe <- factor(Recode(rt$sexe,"1=0;2=1"))
...
Est-ce pertinent de faire de tests de corrélation pour chaque variable? On peut se poser la question, en effet je n'avais aucune hypothèse de départ quant à ces corrélation et multiplier le nombre de tests augmente le risque alpha. Cependant pour les besoins du devoir je le fais quand même.
